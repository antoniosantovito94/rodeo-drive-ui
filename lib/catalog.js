...
const fallbackProducts = [
  ...
  createFallbackProduct({
    id: "uomo-jeans-chiaro-dritto",
    slug: "uomo-jeans-chiaro-dritto",
    image: "uomo-jeans-chiaro-dritto.png",
    alt: "Jeans uomo chiaro dritto",
    name: "Jeans uomo chiaro dritto",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "jeans",
    isNewArrival: true,
    description: "Jeans uomo in denim chiaro con gamba dritta e vestibilita' quotidiana.",
    priceCents: 3990,
    variants: [
      ["46", "Denim chiaro", 3],
      ["48", "Denim chiaro", 4],
  ...
  createFallbackProduct({
    id: "uomo-pantalone-cargo-oliva",
    slug: "uomo-pantalone-cargo-oliva",
    image: "uomo-pantalone-cargo-oliva.png",
    alt: "Pantalone cargo uomo oliva",
    name: "Pantalone cargo uomo oliva",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "pantaloni",
    isNewArrival: true,
    description: "Pantalone cargo uomo color oliva con tasche laterali e fit rilassato.",
    priceCents: 3490,
    variants: [
      ["S", "Oliva", 2],
      ["M", "Oliva", 4],
  ...
  createFallbackProduct({
    id: "uomo-chino-beige",
    slug: "uomo-chino-beige",
    image: "uomo-chino-beige.png",
    alt: "Chino uomo beige",
    name: "Chino uomo beige",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "pantaloni",
    description: "Pantalone chino uomo beige con linea pulita e tessuto morbido.",
    priceCents: 3290,
    variants: [
      ["46", "Beige", 3],
      ["48", "Beige", 3],
  ...
  createFallbackProduct({
    id: "uomo-maglia-righe-navy",
    slug: "uomo-maglia-righe-navy",
    image: "uomo-maglia-righe-navy.png",
    alt: "Maglia uomo righe navy",
    name: "Maglia uomo righe navy",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "maglie",
    isOnSale: true,
    description: "Maglia uomo a righe navy e bianco con mano morbida e taglio essenziale.",
    priceCents: 1990,
  ...
  createFallbackProduct({
    id: "uomo-camicia-lino-bianca",
    slug: "uomo-camicia-lino-bianca",
    image: "uomo-camicia-lino-bianca.png",
    alt: "Camicia uomo lino bianca",
    name: "Camicia uomo lino bianca",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "camicie",
    isNewArrival: true,
    description: "Camicia uomo bianca effetto lino, leggera e facile da abbinare.",
    priceCents: 2990,
    variants: [
      ["S", "Bianco", 2],
      ["M", "Bianco", 4],
  ...
  createFallbackProduct({
    id: "uomo-cintura-pelle-nera",
    slug: "uomo-cintura-pelle-nera",
    image: "uomo-cintura-pelle-nera.png",
    alt: "Cintura uomo pelle nera",
    name: "Cintura uomo pelle nera",
    categorySlug: "uomo",
    categoryName: "Uomo",
    productType: "accessori",
    description: "Cintura uomo in pelle nera con fibbia argento e linea minimal.",
    priceCents: 1490,
    variants: [["Unica", "Nero", 5]],
  }),
];
...
export async function getRelatedProducts(product, limit = 8) {
  ...
  const products = await getPublishedProducts({ categorySlug: product.categorySlug });

  return shuffleProducts(
    products.filter((candidate) => {
      if (candidate.slug === product.slug || candidate.id === product.id) {
        return false;
      }

      return candidate.stockQuantity > 0;
    }),
  ).slice(0, limit);
}
...
function normalizeProduct(product) {
  ...
  return {
    ...
    image: primaryImage?.url ?? "/assets/michele-evangelista-logo-light.svg",
